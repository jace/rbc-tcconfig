...
"""
    ...
    parameters = ['/usr/bin/sudo', '/usr/sbin/rbc_ipconfig_reconfigure', '--restart', '--iftype', form['iftype'].value, '--address', form['ipaddr'].value, '--netmask', form['netmask'].value, '--gateway', form['gateway'].value, '--hostname', form['hostname'].value]
